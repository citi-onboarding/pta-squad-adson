...
export default function ConsultationDetails({ 
  ...
  const consultationData = propConsultationData || 
  ...
  return (
    <div className="w-full max-w-3xl p-6 bg-white rounded-xl">
      <h2 className="text-xl font-bold mb-4">{consultationData.pageTitle}</h2>
      <div className="flex gap-6">
        ...
        <div className="flex flex-col justify-between h-[299px]">
          <div className="mt-14">
            <h3 className="text-2xl font-bold">{consultationData.patient.name}</h3>

            <p className="font-normal mt-2 text-[24px] leading-[110%] tracking-[0] text-[#101010]">
          ...
          <div className="mb-4">
            <p className="text-[#101010] text-[16px] leading-[110%] tracking-[0] font-normal">
              {consultationData.tutor.name}
            </p>


            <p className="mt-3 text-[#101010] text-[16px] leading-[110%] tracking-[0] font-normal">
      ...
      <div className="mt-6">
        <h3 className="font-bold mb-1">{consultationData.problemSection.title}</h3>
      ...
      <div className="mt-6 flex items-center gap-5">
        <h3 className="font-bold">{consultationData.consultation.typeLabel}</h3>

        <span className={`px-4 py-1 rounded-md ${typeColors[consultationData.consultation.type]}`}>
